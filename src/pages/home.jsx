...
export default function Home() {
  ...
  */
  ...
  /* The wiggle function defined in /hooks/wiggle.jsx returns the style effect and trigger funello Rection
  ...
  */
  ...
  return (
    <>
      <h1 className="title">{hello} bisaDiUbah!</h1>
      ...
      <div className="instructions">
        ...
        <p>
          This is the Glitch <strong>Hello React broo</strong> project. You can uses
